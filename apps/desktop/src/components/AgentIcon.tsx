...
/// Vercel's triangle, for fx's gateway provider.
...
/// Grok's own swoosh, not xAI's X: the provider is the Grok subscription, and
/// an X beside two marks that name their product reads as the social network.
/// `fill-rule="evenodd"` for `FxIcon`'s reason — the tail is cut out of the
/// body by a second contour in the one path.
